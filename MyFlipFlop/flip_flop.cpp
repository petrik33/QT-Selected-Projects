    ...
    ui(new Ui::MainWindow)
{
    ui->setupUi(this);
    for (auto i = 0; i < 4; i++) {
        ui->twFlipFlop->setEditTriggers(QAbstractItemView::NoEditTriggers);
...
//    itFlop -> setBackground(QBrush(Qt::green));
    QPixmap pixFlip = QPixmap("C:/Qt/Projects/MyFlipFlop/Image1.jpg").scaled(70, 70, Qt::IgnoreAspectRatio);
    QPixmap pixFlop = QPixmap("C:/Qt/Projects/MyFlipFlop/Image2.jpg").scaled(70, 70, Qt::IgnoreAspectRatio);
